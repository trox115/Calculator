...
class ButtonPanel extends React.Component{
  ...
  <div className="Buttons">
    ...
    <div className="group3">
      <Button btname="4" type="Button" color="gray" onClick={() =>this.handle('4') }/>
      <Button btname="5" type="Button" color="gray" onClick={() =>this.handle('5') }/>
      <Button btname="6" type="Button" color="gray" onClick={() =>this.handle('5') }/>
      <Button btname="-" type="Button" onClick={() =>this.handle('-') }/>
    </div>
    <div className="group4">
      <Button btname="3" type="Button" color="gray" onClick={() =>this.handle('3') }/>
      <Button btname="2" type="Button" color="gray" onClick={() =>this.handle('2') }/>
      <Button btname="1" type="Button" color="gray" onClick={() =>this.handle('1') }/>
